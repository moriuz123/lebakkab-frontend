            ...
            <div class="flex items-center gap-4 mb-4">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex flex-wrap gap-1">
                  <span v-for="kat in app.kategori_aplikasi" :key="kat.id" class="inline-flex items-center px-2 py-1 rounded-md text-[10px] font-bold bg-[#1e5ca8]/10 text-[#1e5ca8] border border-[#1e5ca8]/20 uppercase tracking-wide truncate max-w-full">
                    {{ kat.nama }}
                  </span>
                  <span v-if="!app.kategori_aplikasi || app.kategori_aplikasi.length === 0" class="inline-flex items-center px-2 py-1 rounded-md text-[10px] font-bold bg-gray-100 text-gray-500 border border-gray-200 uppercase tracking-wide truncate max-w-full">Tanpa Kategori</span>
                </div>
              </div>
            </div>

            <h3 class="font-bold text-gray-800 text-lg leading-tight line-clamp-2 mb-3" :title="app.nama">{{ app.nama }}</h3>
