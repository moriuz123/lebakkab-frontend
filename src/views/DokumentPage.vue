          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 border-t-4 border-t-[#e8a020] p-5 sm:p-6 sticky top-6 overflow-hidden relative group/widget">
            ...
            <div class="space-y-5 relative z-10">
              ...
              <div>
                ...
                <div class="relative">
                  <Icon name="lucide:search" class="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    v-model="searchQuery"
                    type="text"
              ...
              <div>
                ...
                <div class="flex flex-col gap-1.5 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                  ...
                  >
                    ...
                    <Icon name="lucide:folder" class="w-3.5 h-3.5 opacity-50 group-hover/btn:opacity-100 shrink-0" />
                  </button>
                </div>
              </div>
            </div>
